...
function mountLinhaRemessaDetalhePadrao() {
  ...
  var conta = getValueOrFiller(document.getElementById("conta"), RemessaPadraoConstants.CONTA,"contaPadrao");
  var dac = getValueOrFiller(document.getElementById("dac"), RemessaPadraoConstants.DAC,"dacPadrao");
  ...
  var nossoNumero = getValueOrFiller(document.getElementById("nossoNumero"), RemessaPadraoConstants.NOSSO_NUMERO,"nossoNumeroPadrao");
  ...
  var codigoOcorrencia = getValueOrFiller(document.getElementById("codigoOcorrencia"), RemessaPadraoConstants.CODIGO_OCORRENCIA,"codigoOcorrenciaPadrao");
